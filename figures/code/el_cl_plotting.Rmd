...
```{r}
test= subset(urb_genes, urb_genes$beta_urb_scale>0)$gene
back<-model_out$gene
...
urb_reduced <- reduceSimMatrix(urb_simMatrix,
                     ...
                     orgdb = org.Hs.eg.db)
treemapPlot(urb_reduced)
#saveRDS(urb_reduced, file = "~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/CL_urb_reduced_24nov25.rds")
```
...
rural_reduced <- reduceSimMatrix(rural_simMatrix,
                     ...
                     threshold = 0.7,   # higher = bigger clusters
                     orgdb = org.Hs.eg.db)
treemapPlot(rural_reduced)
#saveRDS(rural_reduced, file = "~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/CL_rural_reduced_24nov25.rds")
```

```{r}
urb_reduced <- readRDS("~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/CL_urb_reduced_24nov25.rds")
rural_reduced <- readRDS("~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/CL_rural_reduced_24nov25.rds")
...
```{r}
test= subset(early_genes, early_genes$beta_early_scale>0)$gene
back<-model_out$gene
...
urb_reduced <- reduceSimMatrix(urb_simMatrix,
                     ...
                     orgdb = org.Hs.eg.db)
treemapPlot(urb_reduced)
#saveRDS(urb_reduced, file = "~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/EL_urb_reduced_25nov25.rds")
```
...
rural_reduced <- reduceSimMatrix(rural_simMatrix,
                     ...
                     orgdb = org.Hs.eg.db)
treemapPlot(rural_reduced)
#saveRDS(rural_reduced, file = "~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/EL_rural_reduced_25nov25.rds")
```

```{r}
urb_reduced <- readRDS("~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/EL_urb_reduced_25nov25.rds")
rural_reduced <- readRDS("~/Desktop/vandy/lea lab/oa/el_cl/figures/post_wgs_resolution/EL_rural_reduced_25nov25.rds")
...
```{r}
cnetplot(filtered_urban, foldChange = NULL, showCategory = 15)
```
